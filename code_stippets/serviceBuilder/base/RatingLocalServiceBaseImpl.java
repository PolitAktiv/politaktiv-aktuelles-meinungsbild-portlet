 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.PA.meinungsbild.infrastructure.service.impl.RatingLocalServiceImpl}.
 * </p>
 *
 * @author politaktiv
 * @see com.PA.meinungsbild.infrastructure.service.impl.RatingLocalServiceImpl
 * @see com.PA.meinungsbild.infrastructure.service.RatingLocalServiceUtil
 * @generated
 */
public abstract class RatingLocalServiceBaseImpl implements RatingLocalService,
	IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.PA.meinungsbild.infrastructure.service.RatingLocalServiceUtil} to access the rating local service.
	 */
	...
	public Rating addRating(Rating rating) throws SystemException {
		...
		rating = ratingPersistence.update(rating, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(rating);
			}
	...
	public void deleteRating(long ratingId)
		...
		Rating rating = ratingPersistence.remove(ratingId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(rating);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteRating(Rating rating) throws SystemException {
		ratingPersistence.remove(rating);
	...
	public Rating updateRating(Rating rating, boolean merge)
		...
		rating = ratingPersistence.update(rating, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.PA.meinungsbild.infrastructure.model.Rating",
			ratingLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.PA.meinungsbild.infrastructure.model.Rating");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(RatingLocalServiceBaseImpl.class);
